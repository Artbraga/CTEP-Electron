...
import { FormularioTurmaRoute, IdTurmaParameter, PesquisarTurmaParameter, RotaVoltarParameter } from '../../../../model/enums/constants';
...
export class TabelaTurmaComponent extends BaseTable<Turma> implements OnInit {
    ...
    editarTurma(element: Turma) {
        ...
        this.routingService.salvarValor(RotaVoltarParameter, PesquisarTurmaParameter);
